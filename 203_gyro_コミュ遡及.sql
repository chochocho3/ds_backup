...
,hand_st.name as コミュ対応状況
,co.master_appointment_conclusion_status_id as アポ成立ステータスid
,ap_con_st.name as アポ成立ステータス
,optimistic_lock_version as コミュ排他
,co.updated_at as 更新日時
,current_timestamp at time zone 'Japan'
from communications co
join master_handling_statuses hand_st on hand_st.id = co.master_handling_status_id
